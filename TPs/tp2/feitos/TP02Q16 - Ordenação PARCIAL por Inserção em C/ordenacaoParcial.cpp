 ...
 * ordenar essas entradas usando um algoritmo de ordenacao de insercao parcial (sendo k = 10)
 * 1.0.0    24/09/2020
 *
 */
...
void makeLog()
{
    FILE *arquivo = fopen("698774_ordenacaoParcial.txt", "w");
...
int main(void){
	...
	insercaoParcial(jogadores2, v, 10);
