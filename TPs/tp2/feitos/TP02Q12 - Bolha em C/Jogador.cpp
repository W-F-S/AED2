 ...
 * ordenar essas entradas usando um algoritmo de ordenacao Bolha
 *   
 * 1.0.0    24/09/2020
 */
...
/**
 * Funcao para fazer um aquivo de log onde contem
 * 
 * <n_de_matricula>\t<n_comparacoes>\t<n_movimentacoes>\t<tempo> 
 * 
 */
void makeLog()
{
    FILE *arquivo = fopen("698774_bolha.txt", "w");
    fprintf(arquivo, "698774\t%d\t%d\t%f", comparacoes, movimentacoes, tempo);
    fclose(arquivo);
}
